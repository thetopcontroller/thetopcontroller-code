...
//live credentials
$razor_api_key = "RAZORPAY_LIVE_KEY";
$razor_api_secret = "RAZORPAY_SECRET";
...
// $env = 'sandbox';
$env = 'production';
$paypal_sandbox_key = 'PAYPAL_SANDBOX_KEY';
$paypal_production_key = 'PAYPAL_PROD_KEY';
...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=GOGGLE_ANALYTICS_ID"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'GOGGLE_ANALYTICS_ID');
    </script>
    ...
    })(window, document, 'script', 'dataLayer', 'GOGGLE_TAG_MANAGER_ID');</script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GOGGLE_TAG_MANAGER_ID" height="0" width="0"
